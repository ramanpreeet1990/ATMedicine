...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtLogoCreateAccountTitle = (TextView) findViewById(R.id.txt_logo_create_account_title);
        txtLogoCreateAccountTitle.setTypeface(customBold);

        TextView txtLogoCreateAccountSubtitle = (TextView) findViewById(R.id.txt_logo_create_account_subtitle);
    ...
    private void submitCreateAccountForm() {
        ...
        if (!validateEmail(newUserEmailId) || !validatePassword(newUserPassword)
