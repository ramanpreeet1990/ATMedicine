...
public class ForgotPasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView linkCreateAccount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtLogoForgotPasswordTitle = (TextView) findViewById(R.id.txt_logo_forgot_password_title);
        txtLogoForgotPasswordTitle.setTypeface(customBold);

        TextView txtLogoForgotPasswordSubtitle = (TextView) findViewById(R.id.txt_logo_forgot_password_subtitle);
